...
//      this.f_width = this.form_field_jq.outerWidth();
      ...
      if (this.is_multiple) {
        container_div.html('<ul class="chzn-choices"><li class="search-field"><input type="text" id="chosen-search-field-input" maxlength="40" trans="select_some_options" value="' + $.i18n.prop('select_some_options') + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chzn-drop" style="left:-9000px;"><ul class="chzn-results"></ul></div>');
      } else {
    ...
    Chosen.prototype.no_results = function(terms) {
      var no_results_html;
      no_results_html = $('<li class="no-results"><b trans="sms_chat_input_confirm">' + this.results_none_found + '</b> <span></span></li>');
